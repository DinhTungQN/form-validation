...
const checkUsername = () => {
    ...
    if (!isRequired(username)) {
        ...
        showError(usernamEl, 'Username must be between ${min} and ${max} character.')
    } else {
...
const isPasswordSecure = (password) => {
    //Regular expession (check password)
...
form.addEventListener('submit', function (e){
    ...
    let isUsernameValid = checkUsername(),
        ...
        isConfirmPasswordVavid = checkConfirmPassword();
    
    let isFormValid = isUsernameValid &&
        isEmailValid &&
        isPasswordValid &&
        isConfirmPasswordVavid;
